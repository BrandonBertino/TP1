...
print("Se gastaron ", total, "$ en atenciòn a Frida")


# Crear funciòn
def contador(gastos):
    cont=0
    #Recorremos tupla, verificamos si es mayor a 5000, imprimimos retorno
    for i in gastos:
        if(i) > 5000:
            cont += 1
    return "Los gastos de màs de $5.000 son: ", cont

#Ejecutamos funciòn
print(contador(Historial2))
