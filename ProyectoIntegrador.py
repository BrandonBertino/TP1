...
Si el promedio es mayor a 4500 indicar con un mensaje 
...
promLennon = sum (Historial3) / len (Historial3)

if promLennon > 4500:
    print ("Se ha excedido del gasto promedio para su mascota.")
else:
    print ("El promedio de gasto en pesos por la atención de Lennon es de: ", round(promLennon, 2))
